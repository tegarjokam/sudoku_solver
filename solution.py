...
def naked_twins(values):
    ...
    for boxA in out:
        ...
        for boxB in peers[boxA]:
            # print("boxB ->", peers[boxA])
            if (out[boxA] == out[boxB]) and (len(out[boxA]) == 2):
                # print("boxA : ", boxA)
                # print("boxB ", boxB)
                peers_AB = set(peers[boxA]).intersection(set(peers[boxB]))
                # print("peers_AB : ",peers_AB)
                for peer in peers_AB:
                    for digit in out[boxA]:
